...
API_ID = int(environ.get('API_ID', '26047636')) # API ID from my.telegram.org
API_HASH = environ.get('API_HASH', 'd8b1ed69ae1f937c5dd4d3cc8c8de440')  # API Hash from my.telegram.org
...
PICS = (environ.get('PICS', 'https://i.rj1.dev/cqjwO.png')).split()  # Sample pic
NOR_IMG = environ.get("NOR_IMG", "https://i.rj1.dev/cqjwO.png")
MELCOW_PHOTO = environ.get("MELCOW_PHOTO", "https://i.rj1.dev/cqjwO.png")
SPELL_IMG = environ.get("SPELL_IMG", "https://i.rj1.dev/cqjwO.png")
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://i.rj1.dev/cqjwO.png'))
FSUB_PICS = (environ.get('FSUB_PICS', 'https://i.rj1.dev/cqjwO.png')).split()  # Fsub pic

# ============================
# Admin, Channels & Users Configuration
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '8367080346').split()] # Replace with the actual admin ID(s) to add
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1003424586404'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1003424586404'))  # Bin channel id (make sure bot is admin)
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1003424586404'))  # Premium logs channel id
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1003434079874')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1003434079874')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/miraclefilergroup')  # Support group link (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://botskingdom2:t7ognZuINrNfH3tj@cluster0.ystdy4m.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # MongoDB URI for the database
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://rohitreddyathuru:R6Co7MOjTYQOAqcq@cluster0.xrwjpl9.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")  # MongoDB URI for the second database (if MULTIPLE_DB is True)
# ============================
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1003424586404')) #Verification Channel Id 
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1003424586404')) #If Anyone Set Your Bot In Any Group And Set Shortner In That Group Then In This Channel The All Details Come
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/miraclefilergroup') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/miraclefilergroup') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/public_miracle_bots') # Update channel link for the bot
...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '8367080346').split()]
...
URL = "https://funny-jn7r.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else "https://funny-jn7r.onrender.com".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://funny-jn7r.onrender.com".format(FQDN)
else:
    URL = "https://funny-jn7r.onrender.com".format(FQDN)
